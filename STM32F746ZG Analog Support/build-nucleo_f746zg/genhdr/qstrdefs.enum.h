...
QENUM(MP_QSTR_A4)
QENUM(MP_QSTR_A5)
QENUM(MP_QSTR_AUDIO_INT)
QENUM(MP_QSTR_AUDIO_SCL)
QENUM(MP_QSTR_AUDIO_SDA)
...
QENUM(MP_QSTR_EVEN)
QENUM(MP_QSTR_EXT_RST)
QENUM(MP_QSTR_EXT_SCL)
QENUM(MP_QSTR_EXT_SDA)
...
QENUM(MP_QSTR_LCD_BL_CTRL)
QENUM(MP_QSTR_LCD_INT)
QENUM(MP_QSTR_LCD_SCL)
QENUM(MP_QSTR_LCD_SDA)
QENUM(MP_QSTR_LED1)
QENUM(MP_QSTR_LED2)
QENUM(MP_QSTR_LED3)
...
QENUM(MP_QSTR_OTG_FS_OVER_CURRENT)
QENUM(MP_QSTR_OTG_FS_POWER)
QENUM(MP_QSTR_OTG_HS_OVER_CURRENT)
...
QENUM(MP_QSTR_SD_SW)
QENUM(MP_QSTR_SPI)
QENUM(MP_QSTR_SPI_B_MOSI)
QENUM(MP_QSTR_SPI_B_NSS)
QENUM(MP_QSTR_SPI_B_SCK)
QENUM(MP_QSTR_SW)
...
QENUM(MP_QSTR_UART)
QENUM(MP_QSTR_UART2_CTS)
QENUM(MP_QSTR_UART2_RTS)
QENUM(MP_QSTR_UART2_RX)
QENUM(MP_QSTR_UART2_TX)
QENUM(MP_QSTR_UART6_RX)
QENUM(MP_QSTR_UART6_TX)
QENUM(MP_QSTR_UP)
QENUM(MP_QSTR_USB_DM)
QENUM(MP_QSTR_USB_DP)
QENUM(MP_QSTR_USB_ID)
QENUM(MP_QSTR_USB_VBUS)
